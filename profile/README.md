...
In particular,
using the abelian/nonabelian correspondence by Ciocan-Fontanine--Kim--Sabbah [arXiv:math/0610265](https://arxiv.org/abs/math/0610265),
we will calculate its J-function which usually encodes the [Gromov-Witten invariants](https://en.wikipedia.org/wiki/Gromov–Witten_invariant)
of a variety, but turns out to be nontrivial in this case. Furthermore we will construct a certain family of complex tori
